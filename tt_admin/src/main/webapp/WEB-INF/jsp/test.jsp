...
<head>
    ...
    <link href="resources/public/css/blue.css" rel="stylesheet" type="text/css" media="screen" /> <!-- color skin: blue / red / green / dark -->
    ...
    <!-- // Fancybox // -->
  	<script type="text/javascript" src="resources/public/js/jquery.fancybox-1.3.1.js"></script>
